...
const CTASection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success("Thanks for your interest! We'll notify you when Readline launches.");
    setEmail("");
  };
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto glass rounded-2xl p-10 border border-readline-teal/20 shadow-[0_0_40px_rgba(10,250,202,0.15)]">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-glow">Coming Soon</h2>
            <p className="text-xl text-gray-300">
              Join the waitlist to be notified when Readline launches.
            </p>
          </div>
